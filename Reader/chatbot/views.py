...
from .scenario import dust, weather, travel, restaurant, bestseller
...
class AboutChatbot(TemplateView):
    template_name = 'chatbot/about_chatbot.html'

    def get_context_data(self, **kwargs):
        context = {}
        next_url = reverse_lazy('chatbot:about')
